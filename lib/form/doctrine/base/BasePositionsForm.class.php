...
/**
 * Positions form base class.
 *
 * @method Positions getObject() Returns the current form's model object
 *
 * @package    followben
 * @subpackage form
 ...
 */
abstract class BasePositionsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('positions[%s]');
